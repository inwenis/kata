...
test 10 "X 0-0-0-0-0-0-0-0-0-" "X is a strike and counts as 10 pins"
test 12 "X 1-0-0-0-0-0-0-0-0-" "bonus for strike is double pins from next roll"
test 13 "X 1-1-0-0-0-0-0-0-0-" "bonus for strike is double pins from next roll and the roll after it"
...
test 30 "0-0-0-0-0-0-0-0-0-X X X " "2 extra rolls for a strike"
test 32 "0-0-0-0-0-0-0-0-X X 1- " "if you scrore a strike in 8th and 9th frame, the bonus for 8th frames comes frome the extra roll"
test 300 "X X X X X X X X X X X X "
